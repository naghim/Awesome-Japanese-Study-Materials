...
- **Moji - Learn Japanese Daily** [[App Store](https://apps.apple.com/us/app/moji-learn-japanese-daily/id6760421124) // [Website](https://moji.study)] - one curated deck for vocabulary and kanji: hiragana and katakana first, then 7,435 words in frequency order, each tagged N5 to N1 with an example sentence, audio, pitch accent, and (for kanji words) a mnemonic. Reviews are two buttons scheduled by FSRS-6, no setup. Also has stroke-by-stroke kana and kanji writing practice and a placement test. iPhone only. Free to start, with an optional subscription for the focused practice modes.
